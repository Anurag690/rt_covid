var {
    ...
    getNewCasesData, 
    getDistrictData, getDistrictNewCasesData
} =  require('./rtCovid.service');
...
async function Ctrl_RTCovidDistrictData(req, res) {
    try{
        const result = await getDistrictData();
        res.send(result);
    }catch(e) {
        console.log(e);
        res.send({
...
async function Ctrl_DistrictNewCasesData(req, res) {
    try {
        const result = await getDistrictNewCasesData();
        res.send(result);
    }catch(e) {
        console.log(e);
        res.send({
